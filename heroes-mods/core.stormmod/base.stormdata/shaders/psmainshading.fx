...
SPixelOut DefaultPixelMain( in VertexTransportRaw vertRaw ) {
    ...
    int UVMapping[8];
    InitShader( vertRaw, vertOut, UVMapping);
...
//--------------------------------------------------------------------------------------------------
float3 EmitPSBinormal( VertexTransport vertOut ) {
